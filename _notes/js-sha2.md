``` coffeescript
Sha256 = {}
Sha256.hash = (msg, utf8encode) ->
  utf8encode = (if (typeof utf8encode is "undefined") then true else utf8encode)
  msg = Utf8.encode(msg)  if utf8encode
